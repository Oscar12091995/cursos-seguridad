...
//sintaxis para la lectura de archivos
/* else{
            $patron = '/drive\.google\.com\/file\/d\/(.*?)\//';
            $array = preg_match($patron, $url, $parte);
            $lesson->iframe = '<iframe width="400" height="400" src="/https:/drive\.google\.com\/file\/d\/(.*?)\/.*?\?usp=sharing/g", "https://drive.google.com/uc?export=download&id=$1"  frameborder="0"></iframe>';
        } */