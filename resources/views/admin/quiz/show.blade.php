<x-topic-layout>
    ...
    <div class="card my-24 md:mx-48 mx-12">
        <div class="card-body">

            <p class="card-text">
            <div class="row">
                <h5 class="card-title float-start">
                    <a href="{{route('quizzes.index')}}" class="btn btn-sm btn-secondary"><i class="fa fa-arrow-left"></i> Volver a cuestionarios</a>
                </h5>
                ...
                <div class="col-md-8">
                    {{ $quiz->description }}
                    <hr>
                    <h4 class="mt-3 mb-2">Miembros participantes del cuestionario y resultados</h4>
                    <div class="card mt-4">
                        <div class="card-header">
                          <div class="row mt-2">
                            ...
                            <div class="col-md-2">Correctas</div>
                            <div class="col-md-2">Incorrectas</div>
                          </div>
                        </div>
                        <div class="card-body">
