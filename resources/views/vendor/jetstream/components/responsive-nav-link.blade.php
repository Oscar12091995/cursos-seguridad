...
$classes = ($active ?? false)
            ? 'block mr-2 ml-2 pl-3 pr-4 py-2 border-l-4 border-blue-900 text-base font-medium text-indigo-700  focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition'
