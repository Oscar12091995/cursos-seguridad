...
<div class="container ">
   <!-- This example requires Tailwind CSS v2.0+ -->
    <x-table-responsive>
        <div class="pt-4">
          <h1 class="my-5 text-center text-gray-800 text-3xl font-semibold">Listado de Cursos</h1>
        </div>
            ...
            <form>
                <div class="max-w-xl">
                  <div class="flex space-x-1 items-center mb-2">
                    ...
                    <p class="text-black text-lg font-semibold">Buscar curso</p>
                  </div>
                  <div class="flex space-x-4">
                    <div class="flex rounded-md overflow-hidden text-center w-full h-10">
                      <input type="text" class="w-full rounded-md rounded-r-none" wire:keydown="limpiar_page" wire:model="search" />
                      <a class="ml-6 bg-white text-lg w-56 font-semibold pt-1 rounded-md bg-transparent border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-gray-100 focus:border-4 focus:border-red-300" href="{{route('instructor.courses.create')}}">Crear curso</a>
                    </div>
                  </div>
                </div>
              </form>            
            ...
            <tbody class="bg-white divide-y divide-gray-200 text-gray-600 text-sm font-light">
              ...
              <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900 text-center">{{$course->students->count()}}</div>
                  <div class="text-sm text-gray-500 text-center">llevando el curso</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900 flex item-center ml-2">{{$course->rating}}
                        <ul class="flex text-sm align-middle ml-2">
                    ...
                    <div class="text-sm text-gray-500 text-center">Opiniones del curso</div>
                  </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900 text-center">{{$course->hcourse}}</div>
                  </td>
                <td class="py-3 px-6 text-center">
                  <div class="flex item-center justify-center">
                    <div class="transform hover:text-purple-500 hover:scale-110 text-xs">
                      <a href="{{route('instructor.courses.edit', $course)}}" data-toggle="tooltip" data-placement="top" title="Editar curso">
