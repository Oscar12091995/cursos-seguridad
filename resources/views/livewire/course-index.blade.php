            ...
            <div class="flex flex-col md:flex-row">
                  <div class="md:w-1/4 md:border-r-2 border-gray-700 p-4">
                        <div class="sticky inset-x-0 top-0 left-0 py-8 mr-2">
                            ...
                            <button name="cursos" id="cursos" class="bg-white shadow my-4 md:h-12 sm:h-16 px-4 rounded-full mr-4 bg-transparent border-2 border-blue-500 text-black text-lg hover:bg-blue-500 hover:text-gray-100 focus:border-4 focus:border-blue-300" wire:click="resetFilters">
                  ...
                  <div class="md:w-3/4 py-12 sm:px-12 items-center">
    
                      <div class="max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                        {{ $courses->links() }}
                      </div>                
                      <div class="bg-white py-10 pb-50 items-center">
